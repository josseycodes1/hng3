...
This file was extended to include:
- Django REST Framework
- Environment-variable based configuration (python-dotenv + dj-database-url)
- MySQL support via DATABASE_URL (Railway)
- Logging configuration
- WhiteNoise static files setup
- Basic security/production reminders
- Directories for cache and logs
"""
...
# Load environment variables from a .env file in project root (optional)
load_dotenv()
...
INSTALLED_APPS = [
    ...
    # Local apps
    "countries",  # <--- make sure this app exists
]
...
REST_FRAMEWORK = {
    ...
    "PAGE_SIZE": 50,
    "EXCEPTION_HANDLER": "countryapi.exceptions.custom_exception_handler",
}
...
# WhiteNoise configuration (compressed files, caching)
...
REST_FRAMEWORK = {
    ...
    # Keep exception handler default; you can override if you want custom error format
